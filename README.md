# DSA Pattern-Wise Question Bank (LeetCode) 📚

> Note: This is a large curated set per subtopic (not a literal 100% exhaustive scrape of every LeetCode problem ever tagged that way — new problems are added constantly). It's meant to give you enough volume per pattern to build real mastery. Links follow LeetCode's standard URL format.
...
- [Allocate Books / Painter's Partition (GFG classic, similar to Split Array Largest Sum)](https://leetcode.com/problems/split-array-largest-sum/)

---

## 04. Sorting & Partitioning
...
## 05. Prefix Sum & Difference Array
...
- [Maximum Size Rectangle of All 1's (Maximal Rectangle)](https://leetcode.com/problems/maximal-rectangle/)
...
### General / Other must-do LL problems
...
- [Count of Integers Smaller Than or Equal to N With Digit Sum](https://leetcode.com/problems/count-integers-with-even-digit-sum/)
...
## 17. Bit Manipulation & Bitmasking
...
### Sparse Table
- [Range Minimum Query (via Sliding Window Maximum variants)](https://leetcode.com/problems/sliding-window-maximum/)
- [Range Sum Query - Immutable](https://leetcode.com/problems/range-sum-query-immutable/)
...
## 23. Miscellaneous / Special Techniques
...
### Design / Data Structure Implementation
- [LRU Cache](https://leetcode.com/problems/lru-cache/)
- [LFU Cache](https://leetcode.com/problems/lfu-cache/)
...
- [String Matching (Valid State Machine — e.g. Valid Number)](https://leetcode.com/problems/valid-number/)

### Special Mathematical Tricks
- [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/)
- [Gas Station](https://leetcode.com/problems/gas-station/)
- [Majority Element](https://leetcode.com/problems/majority-element/)

### Problems that don't fit elsewhere
- [LFU Cache](https://leetcode.com/problems/lfu-cache/)
- [Median of Two Sorted Arrays](https://leetcode.com/problems/median-of-two-sorted-arrays/)
- [Regular Expression Matching](https://leetcode.com/problems/regular-expression-matching/)
...
**How to use this bank:** Don't try to do every single problem in every subtopic — that's a recipe for burnout. Pick 3-5 problems per subtopic in Tier 1/2 categories (from the priority list), solve them without looking at solutions first, then check patterns you missed. Revisit weak subtopics after a week using spaced repetition.
